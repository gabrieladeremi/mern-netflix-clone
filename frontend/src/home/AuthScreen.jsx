            ...
            <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
                ...
                <form className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleFormSubmit}>
                    <input
                        ...
                        className="flex-1 p-2 rounded bg-black/80 border border-gray-700"
                        value={email}
            ...
            <div className="py-10 bg-black text-white">
                <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
                        ...
                        <div className="relative">
                            ...
                            <div className="flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24
                             border border-slate-500 rounded-md px-2">
                                <img src="/stranger-things-sm.png" alt="Stranger Things logo" className="h-full" />
                    ...
                    <div className="flex-1 md:text-left text-center">
                        ...
                        <p className="text-lg md:text-xl">
                            Save your favorite shows easily and always have something to watch.
                        </p>
                    </div>
                </div>
            </div>
